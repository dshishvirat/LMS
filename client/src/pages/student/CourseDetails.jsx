...
const CourseDetails = () => {
  ...
  if (isError) return <h1>Failed to load course</h1>;
  ...
  const playableLecture = course?.lectures?.find(
    (lec) => lec.videoUrl && (lec.isPreviewFree || purchased),
  );

  const videoSrc = playableLecture?.videoUrl
    ? playableLecture.videoUrl.replace("http://", "https://")
    : null;
          ...
          <Card>
            <CardContent className="p-4 flex flex-col">
              <div className="w-full aspect-video mb-4">
                <div className="w-full aspect-video mb-4 bg-black rounded overflow-hidden">
                  {videoSrc ? (
                    <video
                      src={videoSrc}
                      controls
